...
const CostoPorHora = () => {
    const [gastosFijos, setGastosFijos] = useState(null); // Inicializado como null
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <div className="mb-4">
                    ...
                    <input
                        type="number"
                        id="gastosFijos"
                        value={gastosFijos === null ? '' : gastosFijos}
                        onChange={(e) => {
                            const valor = e.target.value.trim() === '' ? null : parseFloat(e.target.value);
                            setGastosFijos(valor);
                        }}
                ...
                {costoPorHora.length > 0 && (
                    <div className="mt-6">
                        ...
                        <p className="mt-4 text-center">
                            Total de gastos fijos: ${gastosFijos !== null ? gastosFijos.toFixed(2) : ''}
                        </p>
                    </div>
                )}
            </div>
