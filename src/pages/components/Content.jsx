                        ...
                        <Link href="/CostCalculator">
                            <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg"
                                ...
                                <h2 className="text-lg text-white font-medium title-font mb-2">Cálculo del costo por
                                    hora</h2>
                                <p className="leading-relaxed text-base">Determina el costo de tu tiempo por hora
                                    transcurrida.</p>
                            </div>
                        </Link>
                    </div>
                    <div className="xl:w-1/3 md:w-1/2 p-4">
                        <div className="border border-gray-700 border-opacity-75 p-6 rounded-lg"
                            ...
                            <h2 className="text-lg text-white font-medium title-font mb-2">Cálculo del punto de
                                equilibrio</h2>
                            <p className="leading-relaxed text-base">Cuánto tengo que producir y vender para solventar
                                mi estilo de vida.</p>
                        </div>
                    </div>
                    <div className="xl:w-1/3 md:w-1/2 p-4">
