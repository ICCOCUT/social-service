  ...
  return (
    <div>
      <div className='flex justify-center mt-4'>
        ...
        >
          Añade tus gastos fijos mensuales
        </button>
      </div>
      <div>
        <p className='text-center'>Luz, agua, gas, telefonía, renta, alimentación, traslados, diversión.</p>
      </div>
      {isOpen && (
          ...
          <div className="bg-gray-300 text-gray-700 rounded-lg p-8 z-10 max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 mb-2">Servicios (Agua, luz, gas, telefonía, internet, etc.)</label>
                <input
                  type="text"
                  name="servicios"
